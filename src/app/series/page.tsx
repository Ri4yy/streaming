    ...
    return (
        <main className='-mt-20'>
            <section className='lg:px-[80px] md:px-10 px-5 pt-[100px]'>
                <div className="bg-[url(/img/poster/strTh.webp)] bg-center bg-cover rounded-2xl h-[700px] w-full relative overflow-hidden">
                    <div className="absolute md:bottom-5 md:left-5 md:right-5 bottom-0 px-4 py-2.5 bg-black/60 backdrop-blur-md rounded-xl lg:max-w-[700px]">
                        <p className='md:text-3xl text-xl font-medium mb-4'>Очень странные дела</p>
                ...
                <div className="grid xl:grid-cols-4 lg:grid-cols-3 xs:grid-cols-2 mt-20 gap-x-5 gap-y-9">
                    {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                        <MediaCard 
                            ...
                            genre="Фантастика" 
                            rate="8.4" 
                            img="/img/poster/strangerThings.jpg" 
                            type="tv"
                            href="/series/1"
                        />
                    ))}
