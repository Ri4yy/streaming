...
export default function AnimePage() {
    ...
    return (  
        <main className='-mt-20'>
            <section className='relative bg-[url(/img/chainsaw.png)] bg-no-repeat bg-cover bg-[50%_0] w-full lg:h-screen h-fit pt-40 lg:py-0 md:min-h-[800px] flex flex-col justify-center lg:justify-end overflow-hidden'>
                ...
                <div className="min-[1240px]:pl-[calc((100%-1240px)/2)] min-[768px]:pl-10 min-[320px]:pl-5 flex lg:flex-row flex-col gap-20 z-10 lg:items-end">
                    <div className="flex flex-col min-[1440px]:w-[40%] lg:w-[50%] min-[1680px]:pb-[200px] lg:pb-[100px] min-[768px]:pr-10 min-[320px]:pr-5">
                        ...
                        <p className='text-lg font-medium text-[#F8F7F9]/100 p-3 rounded-md bg-white/20 backdrop-blur-sm leading-[1.25]'>У Дэнджи есть простая мечта — жить счастливой и мирной жизнью, проводя время с девушкой, которая ему нравится. 
                            Однако это далеко от реальности, поскольку якудза вынуждает Денджи убивать дьяволов...
                        </p>
                        <div className="flex items-center mt-3 z-20">
                            ...
                            <span className='flex items-center relative before:w-1 before:h-1 before:bg-white/30 before:rounded-full before:absolute before:-left-1/2 ml-8'>2022</span>
                        </div>
                        <div className="flex xs:flex-row flex-col xs:items-center gap-3 mt-12">
                            ...
                            <Link href="/anime/1" className='text-lg hover:text-[#c8de7d] transition-all duration-300'>Подробнее</Link>
                        </div>
                    </div>
                    <div className="min-[1440px]:w-[60%] lg:w-[50%] mb-10">
                        ...
                        >
                            <SwiperSlide>
                                <Image src="/img/animeSwiper1.png" alt="" width={500} height={300} className='w-full object-cover rounded-xl' />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src="/img/animeSwiper2.png" alt="" width={500} height={300} className='w-full object-cover rounded-xl' />
                            </SwiperSlide>
