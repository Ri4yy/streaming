...
export const metadata: Metadata = {
    ...
    description: "Самая полная база аниме на Vixio. Даты выхода новых серий онгоингов, рейтинги, отзывы и описания сюжетов. Найдите свое любимое аниме.",
    openGraph: {
        title: "Лучшие аниме на Vixio",
