...
export const metadata: Metadata = {
    ...
    description: "Огромная база фильмов на Vixio. Ищите фильмы по жанрам, годам и рейтингу. Читайте обзоры, смотрите трейлеры, изучайте актерский состав.",
    openGraph: {
        title: "Лучшие фильмы на Vixio",
        description: "Огромная база фильмов на Vixio. Ищите фильмы по жанрам, годам и рейтингу.",
    }
};
