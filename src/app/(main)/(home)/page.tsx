...
export const metadata: Metadata = {
    title: "Vixio — Смотреть фильмы, сериалы и аниме в высоком качестве",
    description: "Vixio — крупнейший каталог кино. Узнайте рейтинг фильмов, актерский состав, даты выхода новинок и читайте отзывы. Добавляйте в избранное и делитесь с друзьями.",
    openGraph: {
        title: "Vixio — Каталог фильмов, сериалов и аниме",
