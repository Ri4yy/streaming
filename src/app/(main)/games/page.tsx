...
export const metadata: Metadata = {
    ...
    description: "Самая полная база видеоигр на Vixio. Узнайте даты релиза, системные требования, рейтинг Metacritic и читайте отзывы геймеров. Найдите во что поиграть.",
    openGraph: {
        title: "Лучшие видеоигры на Vixio",
