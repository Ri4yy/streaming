...
export const metadata: Metadata = {
    ...
    description: "Лучшие сериалы со всего мира на Vixio. Узнайте даты выхода новых серий, читайте отзывы и рецензии, изучайте актерский состав и рейтинг.",
    openGraph: {
        title: "Лучшие сериалы на Vixio",
