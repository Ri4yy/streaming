            ...
            <div className="rounded-2xl backdrop-blur-xl bg-black/40 border border-white/10 shadow-lg shadow-black/20 overflow-hidden relative p-8 md:p-12">
                ...
                <div className="flex flex-col md:flex-row justify-between gap-10">
                    ...
                    <div className="flex flex-col gap-4 items-start md:items-end">
                        <h3 className="text-white font-medium uppercase tracking-wider text-sm mb-2">Контакты</h3>
                        <a href="mailto:vixio.online@proton.me" className="text-gray-400 hover:text-white hover:translate-x-1 md:hover:-translate-x-1 transition-all duration-300">vixio.online@proton.me</a>
