            ...
            <div className="container flex md:flex-row flex-col justify-between items-center gap-x-14">
                <div className="md:w-2/5">
                    ...
                    <div className="flex items-center mt-3">
                        ...
                        <span className='pl-2 pr-4'>{movie.vote_average ? movie.vote_average.toFixed(1) : '0.0'}</span>
                        <ul className='flex items-center text-white/80 gap-x-4'>
                            <li><div className="h-1 w-1 rounded-full bg-white/30"></div></li>
                            <li>{movie.release_date ? movie.release_date.split('-')[0] : 'N/A'}</li>
                        </ul>
                    </div>
                    <p className='text-[#e8dfde] py-8 line-clamp-4'>
