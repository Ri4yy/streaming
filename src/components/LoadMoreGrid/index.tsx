        ...
        <div className="flex flex-col items-center">
            ...
            {page < totalPages && items.length > 0 && (
                <button 
                    ...
                    disabled={isLoading}
                    className="mt-12 px-8 py-3 bg-theme-gradient text-white hover:opacity-90 font-semibold rounded-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center min-w-[200px]"
                >
                    {isLoading ? (
