    ...
    return (
        <div className="w-full bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 mt-12 mb-20 shadow-lg backdrop-blur-sm">
            ...
            <div className={`mt-4 text-white/50 text-sm leading-relaxed transition-all duration-300 overflow-hidden ${expanded ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0 m-0'}`}>
                ...
                <p className="mb-3">
                    Мы регулярно обновляем списки, добавляя свежие новинки 2026 года, а также бессмертную классику кинематографа и игровой индустрии. Вы можете использовать удобные фильтры по настроению, чтобы найти контент, который идеально подойдет под ваше текущее эмоциональное состояние. Смотреть фильмы онлайн в хорошем качестве или искать лучшие RPG игры теперь стало намного проще благодаря нашей системе умных подборок.
                </p>
                <p>
                    <strong>Ключевые слова:</strong> подборки фильмов, лучшие сериалы 2026, что посмотреть вечером, топ аниме, игры для слабого ПК, кино по жанрам, фильмотека, каталог игр, рейтинги, рекомендации.
                </p>
            </div>
        </div>
    );
